...
export function Thread() {
  ...
  const [promptHistoryOpen, setPromptHistoryOpen] = useQueryState(
    "promptHistoryOpen",
          ...
          <div className="absolute top-0 left-0 w-full flex items-center justify-between gap-3 p-2 pl-4 z-10">
            ...
            <div className="flex items-center gap-2">
              <Button
                className="hover:bg-gray-100"
                variant="ghost"
                onClick={() => setPromptHistoryOpen((p) => !p)}
              >
          ...
          <div className="flex items-center justify-between gap-3 p-2 z-10 relative">
            ...
            <div className="flex items-center gap-4">
              ...
              <TooltipIconButton
                size="lg"
                className="p-4"
                tooltip={promptHistoryOpen ? "Hide prompts" : "Show prompts"}
                variant="ghost"
                onClick={() => setPromptHistoryOpen((p) => !p)}
              >
                <MessageSquare className="size-5" />
                  ...
                  .map((message, index) =>
                    message.type === "human" ? (
                      <HumanMessage
                        ...
                        message={message}
                        isLoading={isLoading}
                        messageId={`human-msg-${message.id}`}
                      />
                    ) : (
                      <AssistantMessage
                        key={message.id || `${message.type}-${index}`}
